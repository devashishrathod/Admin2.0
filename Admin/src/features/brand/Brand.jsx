...
// const STATUS_TABS = ["All", "Pending", "UnderListing"];
...
//               <div>
//                 <p className="text-[11px] text-neutral-500">GST Number</p>
//                 <p className="text-[13px] font-medium text-neutral-200">{brand.gstNumber}</p>
//               </div>
//             </div>
//             <span
...
//               }`}
//             >
//               {brand.gstVerified ? "Verified" : "Unverified"}
//             </span>
//           </div>
...
//               <div>
//                 <p className="text-[11px] text-neutral-500">PAN Number</p>
//                 <p className="text-[13px] font-medium text-neutral-200">{brand.panNumber}</p>
//               </div>
//             </div>
//             <span
//               className={`rounded-full px-2 py-0.5 text-[10.5px] font-semibold ${
...
//               }`}
//             >
//               {brand.panVerified ? "Verified" : "Unverified"}
//             </span>
//           </div>

//           <div className="flex items-center justify-between rounded-xl border border-neutral-800 bg-neutral-950 px-3.5 py-2.5">
//             <div className="flex items-center gap-2.5">
//               <Landmark size={15} className="text-neutral-500" />
//               <div>
//                 <p className="text-[11px] text-neutral-500">Bank Account · {brand.bankName}</p>
//                 <p className="text-[13px] font-medium text-neutral-200">{brand.accountHolder}</p>
//               </div>
//             </div>
//             <span
//               className={`rounded-full px-2 py-0.5 text-[10.5px] font-semibold ${
...
//               }`}
//             >
//               {brand.bankVerified ? "Verified" : "Unverified"}
//             </span>
//           </div>
//         </div>
//       </SectionCard>
